    ...
    render(){
        return (
            <div className= "Home"  >
                ...
                <img src= {kcLogo} alt= "kcLogo" className = "logo" />
            </div>
        ) //return 
    } //render
} //Home